...
#define IN1 8
#define IN2 9
#define ENA 10 // this pin must be PWM enabled pin

// motor 2 settings
#define IN3 12
#define IN4 13
#define ENB 11 // this pin must be PWM enabled pin
...
void loop() {
  ...
  motor.rotate(motor2, 50, CW);//run motor2 at 50% speed in CW direction  
  delay(4000);
